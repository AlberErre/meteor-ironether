...
@class [template] dapp_selectAccount_iron
@constructor
*/

Template['dapp_selectAccount_iron'].onCreated(function(){
    if(this.data ) {
        if(this.data.value) {
...
Template['dapp_selectAccount_iron'].helpers({
    /**
...
Template['dapp_selectAccount_iron'].events({
    /**
